...
rawLIWCData = importdata(['dataSet2_min25_LIWC2015 results_150_10_min25.csv']);
...
ratingDataFile = 'dataSet2_ESM_rating data.xlsx'; 
...
subjectIDlistLIWC(subjectsToDrop) = [];
